...
<head>
<meta charset="UTF-8">
<title>Reset Password - PeakRent</title>
...
<nav class="flex justify-between items-center px-10 py-4 bg-white border-b">
    ...
    <div class="flex gap-4 items-center">
        ...
        <div class="flex items-center gap-3 relative group">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 cursor-pointer text-green-700 hover:text-green-900 transition">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            </svg>
            <!-- DROPDOWN -->
            <div class="hidden group-hover:block absolute top-10 right-0 w-48 bg-white rounded-2xl shadow-xl p-3 border z-50">
...
<section class="px-6 md:px-10 py-6">
    ...
    <a href="{{ url('/lupa-password') }}" class="text-sm text-gray-600 hover:text-green-800">
        ← Kembali
    </a>
    ...
    <div class="flex items-center justify-center py-6">
        ...
        <div class="w-full max-w-[430px] bg-white rounded-xl shadow-2xl overflow-hidden">
           ...
           <div class="px-8 py-8">
            ...
            <h1 class="text-2xl font-bold text-[#075B43] mb-2">
                Reset Password
            </h1>

            <p class="text-sm text-gray-600 mb-6">
                Masukkan password baru untuk mengamankan akunmu.
            </p>
